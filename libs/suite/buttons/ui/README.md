...
`suite-ui` contains a set of **standalone Angular components** and utilities designed to accelerate frontend development:

- **Abstract** (`AbstractButton`)
  - Inputs / Output signals

- **Buttons** (`SuiteButton`)  -> MatButton
- **MiniFabButtons** (`SuiteMiniFabButton`)  -> MatMiniFab
